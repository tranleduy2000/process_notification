...
//            startActivity(new Intent(this, StartActivity.class));
    ...
    protected void onResume() {
        ...
        if (behavior.getState() == BottomSheetBehavior.STATE_HIDDEN) {
            ...
            } else if (searchView != null && StaticUtils.shouldShowTutorial(MainActivity2.this, "search", 1)) {
            ...
            } else if (tabLayout != null && viewPager != null && viewPager.getCurrentItem() != 3 && StaticUtils.shouldShowTutorial(MainActivity2.this, "faqs", 2)) {
            ...
            } else if (StaticUtils.shouldShowTutorial(MainActivity2.this, "donate", 3)) {
